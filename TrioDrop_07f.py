...
# ──────────────────────────────────────────────────────────────
# 📁 UI & File Uploads
st.header("🧬 Data Feed Processor v07f with Meas selector")
...
if report_mode == "Choose a time":
    ...
    report_time = None  # Auto-set later
...
if small_feed_file and big_feed_file and measurement_file:
    try:
        ...
        # Auto-set report time if needed
        ...
        if report_time is None or input_value is None:
            ...
            filename = f"origin_report_{report_time.strftime('%y-%m-%d_%H-%M')}.csv"
